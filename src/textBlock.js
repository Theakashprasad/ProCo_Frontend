    ...
    <div id="textblock">
      <div id="textblock-container">
        ...
        <p id="textblock-content">
          ...
          mountain, its your job to find smoke and keep the wilderness safe.
          <br />
          <br />
          ...
          handheld radio—and is your only contact with the world youve left
          behind.
          <br />
          <br />
          But when something strange draws you out of your lookout tower and
          into the world below, youll explore a wild and unknown environment,
