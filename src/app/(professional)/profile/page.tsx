  ...
  return (
    <div className="bg-black min-h-screen text-white p-5">
      <div className="container mx-auto py-5">
        ...
        <div className="flex">
          <div className="w-1/4">
            <div className="bg-[#0d0d0d] p-4 rounded-lg pb-10">
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    <button
                      ...
                      className="w-full text-left text-white bg-[#1b1b1b] p-2 hover:bg-[#343434] rounded-md focus:outline-none flex justify-between items-center "
                    >
                      PROFILE
                    </button>
                  </div>
                ...
                <div className="bg-[#0d0d0d] p-8 rounded-lg">
                  ...
                  <div className="flex items-center mb-6">
                    ...
                    {user?.isPro ? (
                      ...
                      <button
                        ...
                        type="button"
                        onClick={() => router.push(`/chat/${proData?._id}`)}
                      >
                  ...
                  <div className="text-white">
                    <div className="container mx-auto ">
                      <div className="bg-[#1b1b1b]  p-8 rounded-lg mb-6">
                      ...
                      <div className="bg-[#1b1b1b]  p-8 rounded-lg">
